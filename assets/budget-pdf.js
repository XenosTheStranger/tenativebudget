...
@media print{
  ...
  *::after{
  ...
  main:not(#content):not(#main-content)::before{
    ...
    border-bottom:2px solid #003f28 !important;
  ...
  header.header{
    ...
    overflow:visible !important;
    border:0 !important;
    border-left:.06in solid #003f28 !important;
    border-radius:0 !important;
    position:relative !important;
  }
  ...
  /* Revenue Budget/Expenses "View Budget Lines" detail: the actual-
  ...
  /* Revenue Budget / Summary of Expenses: drop the FY2020 and FY2021
  ...
  /* Summary of Expenses' own "View Budget Lines" detail (department-level,
     ...
     print-only table the way Revenue Budget does -- it's the same
  ...
  /* Revenue Budget / Summary of Expenses: nothing after the summary
...
`;
  ...
  function ensureStatementPanel() {
    ...
    // something else, like Revenue Budget' "Revenue Overview" or
